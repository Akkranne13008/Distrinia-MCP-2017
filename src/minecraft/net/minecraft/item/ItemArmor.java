...
public class ItemArmor extends Item
{
    ...
    public static enum ArmorMaterial
    {
        ...
        DIAMOND("DIAMOND", 4, 20, new int[]{3, 8, 6, 3}, 10),
    	
    	AMETRINE("AMETRINE", 8, 110, new int[]{3, 8, 6, 3}, 10),
		ETAIN("ETAIN", 7, 83, new int[]{3, 8, 6, 3}, 10),
		BORNITE("BORNITE", 6, 63, new int[]{3, 8, 6, 10}, 10),
        CUIVRE("CUIVRE", 5, 43, new int[]{3, 8, 6, 3}, 10);
        ...
        private static final ItemArmor.ArmorMaterial[] $VALUES = new ItemArmor.ArmorMaterial[]{CLOTH, CHAIN, IRON, GOLD, DIAMOND, CUIVRE, BORNITE, ETAIN, AMETRINE,};
