...
public class Potion
{
    ...
    public static final Potion nofall = (new Potion(24, false, 3484199)).setPotionName("potion.nofall").setIconIndex(13, 1);
    ...
    public static final Potion field_76443_y = (new PotionHealth(23, false, 16262179)).setPotionName("potion.saturation").setIconIndex(12, 1);;
