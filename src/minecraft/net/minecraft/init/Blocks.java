...
public class Blocks
{
    ...
    public static final Block blockAntiPiston = (Block)Block.blockRegistry.getObject("antipiston_block");
    public static final Block tnt_uranium = (Block)Block.blockRegistry.getObject("tnt_uranium");
    public static final Block obsidian_uranium = (Block)Block.blockRegistry.getObject("obsidian_uranium"); 
