...
public class GuiButtonAuctionBack extends ZButton{
	...
	public GuiButtonAuctionBack(int p_i1041_1_, int p_i1041_2_, int p_i1041_3_, int largeur, int largeur2, String text, BackType type)
	{
