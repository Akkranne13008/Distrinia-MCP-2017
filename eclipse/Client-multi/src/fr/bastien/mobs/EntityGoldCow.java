...
public class EntityGoldCow extends EntityAnimal {
   ...
   protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         this.func_145779_a(Items.uranium, 1);
      }
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         if(var3 == 1) {
            this.func_145778_a(Items.uranium, 1, 1.0F);
         }
      }
   ...
   public EntityGoldCow createChild1(EntityAgeable p_90011_1_) {
