...
public class EntityHellCow extends EntityAnimal {
   ...
   protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         this.func_145779_a(Items.Cuire_De_Farm, 1);
      }
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         if(var3 == 1) {
            this.func_145778_a(Items.Cuire_De_Farm, 1, 1.0F);
         }
      }
   ...
   public EntityHellCow createChild1(EntityAgeable p_90011_1_) {
