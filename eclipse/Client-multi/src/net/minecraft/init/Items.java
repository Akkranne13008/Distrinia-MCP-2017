...
public class Items
{
    ...
    public static final Item cuivre_sword = (Item)Item.itemRegistry.getObject("cuivre_sword");
    
    public static final Item candybleu = (Item)Item.itemRegistry.getObject("candybleu");
    public static final Item candyvert = (Item)Item.itemRegistry.getObject("candyvert");
    public static final Item Cuire_De_Farm = (Item)Item.itemRegistry.getObject("Cuire_De_Farm");
