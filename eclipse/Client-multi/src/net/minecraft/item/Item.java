...
import fr.telozia.bastienr.Hammer;
import fr.telozia.bastienr.Paxel;
import fr.telozia.bastienr.flower;
...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        int id = 700;
        //  ►Telozia V1 | Item Special◄
        itemRegistry.addObject(id++, "Cuire_De_Farm", (new Item()).setUnlocalizedName("Cuire_De_Farm").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("cuirdechevre"));

        
        
        // ►Telozia V1 | Minerais ◄ 
        
        itemRegistry.addObject(id++, "cuivre", (new Item()).setUnlocalizedName("cuivre").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("cuivre"));
        itemRegistry.addObject(id++, "bornite", (new Item()).setUnlocalizedName("bornite").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("bornite"));
        itemRegistry.addObject(id++, "etain", (new Item()).setUnlocalizedName("etain").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("etain"));
        itemRegistry.addObject(id++, "ametrine", (new Item()).setUnlocalizedName("ametrine").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("ametrine"));
        itemRegistry.addObject(id++, "uranium", (new Item()).setUnlocalizedName("uranium").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("uranium"));
        ...
        itemRegistry.addObject(id++, "candybleu",new ItemFood(4, 0.5F, false).setAlwaysEdible()
    			.setPotionEffect(Potion.nofall.id, 300, 0, 1.0F).setUnlocalizedName("candybleu").setTextureName("candy_cane_bleu"));
        itemRegistry.addObject(id++, "candyvert", new ItemFood(4, 0.3F, false).setAlwaysEdible()
    			.setPotionEffect(Potion.field_76443_y.id, 300, 0, 1.0F).setUnlocalizedName("candyvert").setTextureName("candy_cane_vert"));
        // ►Telozia V1 | Outils ◄ 
        
        itemRegistry.addObject(id++, "cuivre_shovel", (new ItemSpade(Item.ToolMaterial.CUIVRE)).setUnlocalizedName("shovelCuivre").setTextureName("cuivre_shovel"));
        itemRegistry.addObject(id++, "cuivre_pickaxe", (new ItemPickaxe(Item.ToolMaterial.CUIVRE)).setUnlocalizedName("pickaxeCuivre").setTextureName("cuivre_pickaxe"));
        itemRegistry.addObject(id++, "cuivre_axe", (new ItemAxe(Item.ToolMaterial.CUIVRE)).setUnlocalizedName("hatchetCuivre").setTextureName("cuivre_axe"));
        itemRegistry.addObject(id++, "cuivre_hoe", (new ItemHoe(Item.ToolMaterial.CUIVRE)).setUnlocalizedName("hoeCuivre").setTextureName("cuivre_hoe"));
        
        itemRegistry.addObject(id++, "bornite_shovel", (new ItemSpade(Item.ToolMaterial.BORNITE)).setUnlocalizedName("shovelBornite").setTextureName("bornite_shovel"));
        itemRegistry.addObject(id++, "bornite_pickaxe", (new ItemPickaxe(Item.ToolMaterial.BORNITE)).setUnlocalizedName("pickaxeBornite").setTextureName("bornite_pickaxe"));
        itemRegistry.addObject(id++, "bornite_axe", (new ItemAxe(Item.ToolMaterial.BORNITE)).setUnlocalizedName("hatchetBornite").setTextureName("bornite_axe"));
        itemRegistry.addObject(id++, "bornite_hoe", (new ItemHoe(Item.ToolMaterial.BORNITE)).setUnlocalizedName("hoeBornite").setTextureName("bornite_hoe"));
        
        itemRegistry.addObject(id++, "etain_shovel", (new ItemSpade(Item.ToolMaterial.ETAIN)).setUnlocalizedName("shovelEtain").setTextureName("etain_shovel"));
        itemRegistry.addObject(id++, "etain_pickaxe", (new ItemPickaxe(Item.ToolMaterial.ETAIN)).setUnlocalizedName("pickaxeEtain").setTextureName("etain_pickaxe"));
        itemRegistry.addObject(id++, "etain_axe", (new ItemAxe(Item.ToolMaterial.ETAIN)).setUnlocalizedName("hatchetEtain").setTextureName("etain_axe"));
        itemRegistry.addObject(id++, "etain_hoe", (new ItemHoe(Item.ToolMaterial.ETAIN)).setUnlocalizedName("hoeEtain").setTextureName("etain_hoe"));
        
        itemRegistry.addObject(id++, "ametrine_shovel", (new ItemSpade(Item.ToolMaterial.AMETRINE)).setUnlocalizedName("shovelAmetrine").setTextureName("ametrine_shovel"));
        itemRegistry.addObject(id++, "ametrine_pickaxe", (new ItemPickaxe(Item.ToolMaterial.AMETRINE)).setUnlocalizedName("pickaxeAmetrine").setTextureName("ametrine_pickaxe"));
        itemRegistry.addObject(id++, "ametrine_axe", (new ItemAxe(Item.ToolMaterial.AMETRINE)).setUnlocalizedName("hatchetAmetrine").setTextureName("ametrine_axe"));
        itemRegistry.addObject(id++, "ametrine_hoe", (new ItemHoe(Item.ToolMaterial.AMETRINE)).setUnlocalizedName("hoeAmetrine").setTextureName("ametrine_hoe"));

        
        // ►Telozia V1 | Combat ◄
        
        itemRegistry.addObject(id++, "cuivre_sword", (new ItemSword(Item.ToolMaterial.CUIVRE)).setUnlocalizedName("swordcuivre").setTextureName("cuivre_sword"));
        
        itemRegistry.addObject(id++, "bornite_sword", (new ItemSword(Item.ToolMaterial.BORNITE)).setUnlocalizedName("swordbornite").setTextureName("bornite_sword"));
        
        itemRegistry.addObject(id++, "etain_sword", (new ItemSword(Item.ToolMaterial.ETAIN)).setUnlocalizedName("swordetain").setTextureName("etain_sword"));
        
        itemRegistry.addObject(id++, "ametrine_sword", (new ItemSword(Item.ToolMaterial.AMETRINE)).setUnlocalizedName("swordametrine").setTextureName("ametrine_sword"));
        
        // ►Telozia V1 | Armure ◄
        
        itemRegistry.addObject(id++, "cuivre_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.CUIVRE, 5, 0)).setUnlocalizedName("helmetCuivre").setTextureName("cuivre_helmet"));
        itemRegistry.addObject(id++, "cuivre_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.CUIVRE, 5, 1)).setUnlocalizedName("chestplateCuivre").setTextureName("cuivre_chestplate"));
        itemRegistry.addObject(id++, "cuivre_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.CUIVRE, 5, 2)).setUnlocalizedName("leggingsCuivre").setTextureName("cuivre_leggings"));
        itemRegistry.addObject(id++, "cuivre_boots", (new ItemArmor(ItemArmor.ArmorMaterial.CUIVRE, 5, 3)).setUnlocalizedName("bootsCuivre").setTextureName("cuivre_boots"));
        
        itemRegistry.addObject(id++, "bornite_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.BORNITE, 6, 0)).setUnlocalizedName("helmetBornite").setTextureName("bornite_helmet"));
        itemRegistry.addObject(id++, "bornite_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.BORNITE, 6, 1)).setUnlocalizedName("chestplateBornite").setTextureName("bornite_chestplate"));
        itemRegistry.addObject(id++, "bornite_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.BORNITE, 6, 2)).setUnlocalizedName("leggingsBornite").setTextureName("bornite_leggings"));
        itemRegistry.addObject(id++, "bornite_boots", (new ItemArmor(ItemArmor.ArmorMaterial.BORNITE, 6, 3)).setUnlocalizedName("bootsBornite").setTextureName("bornite_boots"));
        
        itemRegistry.addObject(id++, "etain_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.ETAIN, 7, 0)).setUnlocalizedName("helmetEtain").setTextureName("etain_helmet"));
        itemRegistry.addObject(id++, "etain_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.ETAIN, 7, 1)).setUnlocalizedName("chestplateEtain").setTextureName("etain_chestplate"));
        itemRegistry.addObject(id++, "etain_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.ETAIN, 7, 2)).setUnlocalizedName("leggingsEtain").setTextureName("etain_leggings"));
        itemRegistry.addObject(id++, "etain_boots", (new ItemArmor(ItemArmor.ArmorMaterial.ETAIN, 7, 3)).setUnlocalizedName("bootsEtain").setTextureName("etain_boots"));
        
        itemRegistry.addObject(id++, "ametrine_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.AMETRINE, 8, 0)).setUnlocalizedName("helmetAmetrine").setTextureName("ametrine_helmet"));
        itemRegistry.addObject(id++, "ametrine_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.AMETRINE, 8, 1)).setUnlocalizedName("chestplateAmetrine").setTextureName("ametrine_chestplate"));
        itemRegistry.addObject(id++, "ametrine_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.AMETRINE, 8, 2)).setUnlocalizedName("leggingsAmetrine").setTextureName("ametrine_leggings"));
        itemRegistry.addObject(id++, "ametrine_boots", (new ItemArmor(ItemArmor.ArmorMaterial.AMETRINE, 8, 3)).setUnlocalizedName("bootsAmetrine").setTextureName("ametrine_boots"));
        
        itemRegistry.addObject(id++, "farm_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.AMETRINE, 9, 0)).setUnlocalizedName("helmetFarm").setTextureName("farmhelmet"));
        itemRegistry.addObject(id++, "farm_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.AMETRINE, 9, 1)).setUnlocalizedName("chestplateFarm").setTextureName("farmchestplate"));
        itemRegistry.addObject(id++, "farm_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.AMETRINE, 9, 2)).setUnlocalizedName("leggingsFarm").setTextureName("farmleggings"));
        itemRegistry.addObject(id++, "farm_boots", (new ItemArmor(ItemArmor.ArmorMaterial.AMETRINE, 9, 3)).setUnlocalizedName("bootsFarm").setTextureName("farmboots"));
        
        // ►Telozia V1 | Effet ◄ 
        
        itemRegistry.addObject(id++, "fleur_force", (new Item()).setFull3D().setUnlocalizedName("fleur_force").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("flower_force"));
        itemRegistry.addObject(id++, "fleur_speed", (new Item()).setFull3D().setUnlocalizedName("fleur_speed").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("flower_speed"));
        itemRegistry.addObject(id++, "fleur_fire", (new flower().setUnlocalizedName("fleur_fire").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("flower_ressistance_au_feu")));
        itemRegistry.addObject(id++, "fleur_heal", (new Item()).setFull3D().setUnlocalizedName("fleur_heal").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("flower_heal"));
        itemRegistry.addObject(id++, "fleur_haste", (new Item()).setFull3D().setUnlocalizedName("fleur_haste").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("flower_haste"));
        itemRegistry.addObject(id++, "fleur_regeneration", (new flower().setUnlocalizedName("fleur_regeneration").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("flower_regeneration")));
        
        
        // ►Telozia V1 | Item Uranium ◄ 
        
        
        itemRegistry.addObject(id++, "uranium_paxel", (new Paxel(Item.ToolMaterial.AMETRINE)).setUnlocalizedName("uranium_paxel").setTextureName("uranium_paxel"));
        itemRegistry.addObject(id++, "Triple_uranium", new Hammer(ToolMaterial.AMETRINE).setUnlocalizedName("Triple_uranium").setTextureName("Triple_uranium"));
    ...
    {
    	if (par1ItemStack.getItem() == Items.candyvert) // on cherche l'item
        	par3List.add("§5» §dDonne l'effet de §5Full Eat §d pendant §55 §dminutes"); // on ajoute la description
    	
    	if (par1ItemStack.getItem() == Items.candybleu) // on cherche l'item
        	par3List.add("§5» §dDonne l'effet de §5No Fall §dpendant §55 §dminutes"); // on ajoute la description
    	
       	if (par1ItemStack.getItem() == getItemFromBlock(Blocks.tnt_uranium)) 
        	par3List.add("§5» §dEffet d'explosion de §5x3"); // on ajoute la description 
       	if (par1ItemStack.getItem() == getItemFromBlock(Blocks.tnt)) 
        	par3List.add("§5» §dEffet d'explosion de §5x1"); // on ajoute la description 	
       	if (par1ItemStack.getItem() == getItemFromBlock(Blocks.blockAntiPiston)) 
        	par3List.add("§5» §dBlock §5Anti Piston §dmais cassable à la §5TNT"); // on ajoute la description 	
       	if (par1ItemStack.getItem() == getItemFromBlock(Blocks.obsidian_uranium)) 
        	par3List.add("§5» §dBlock §5Incassable §det §5Anti Piston"); // on ajoute la description 	
       	if (par1ItemStack.getItem() == getItemFromBlock(Blocks.obsidian)) 
        	par3List.add("§5» §dBlock §5Pétable §dau bout de §510 TNT"); // on ajoute la description 	
    }
    ...
    public static enum ToolMaterial
    {
        ...
        STONE("STONE", 1, 1, 131, 4.0F, 0.75F, 5),
        IRON("IRON", 2, 2, 250, 6.0F, 1.0F, 14),
        EMERALD("EMERALD", 3, 3, 1561, 8.0F, 1.5F, 10),
        GOLD("GOLD", 4, 0, 32, 12.0F, 0.0F, 22),

        
    	AMETRINE("AMETRINE", 5, 9, 6000, 35.5F, 3.75F, 10), 
		ETAIN("ETAIN", 6, 8, 5000, 25, 3.5F, 10),
		BORNITE("BORNITE", 7, 7, 4500, 20.5F, 2.75F, 10),
        CUIVRE("CUIVRE", 5, 6, 4000, 15.5F, 2.5F, 10);
        ...
        private static final Item.ToolMaterial[] $VALUES = new Item.ToolMaterial[]{WOOD, STONE, IRON, EMERALD, GOLD, CUIVRE};
