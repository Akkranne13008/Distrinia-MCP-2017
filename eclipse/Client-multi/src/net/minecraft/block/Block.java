...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        blockRegistry.addObject(id++, "cuivre_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("oreCuivre").setBlockTextureName("cuivre_ore"));
        blockRegistry.addObject(id++, "cuivre_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("blockCuivre").setBlockTextureName("cuivre_block"));
        
        blockRegistry.addObject(id++, "bornite_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("oreBornite").setBlockTextureName("bornite_ore"));
        blockRegistry.addObject(id++, "bornite_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("blockBornite").setBlockTextureName("bornite_block"));
        
        blockRegistry.addObject(id++, "etain_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("oreEtain").setBlockTextureName("etain_ore"));
        blockRegistry.addObject(id++, "etain_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("blockEtain").setBlockTextureName("etain_block"));
        
        blockRegistry.addObject(id++, "ametrine_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("oreAmetrine").setBlockTextureName("ametrine_ore"));
        blockRegistry.addObject(id++, "ametrine_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("blockAmetrine").setBlockTextureName("ametrine_block"));
        
        blockRegistry.addObject(id++, "uranium_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("oreUranium").setBlockTextureName("uranium_ore"));
        blockRegistry.addObject(id++, "uranium_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("blockUranium").setBlockTextureName("uranium_block"));
        
        blockRegistry.addObject(id++, "antipiston_block", (new Block(Material.anvil)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypePiston).setBlockName("blockAntiPiston").setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("uranium_brique"));
        
        blockRegistry.addObject(id++, "tnt_uranium", (new BlockTNT(3.0F)).setHardness(0.0F).setStepSound(soundTypeGrass).setBlockName("tnt_uranium").setBlockTextureName("uranium_tnt"));
        
        blockRegistry.addObject(id++, "obsidian_uranium", (new BlockObsidian()).setHardness(50.0F).setResistance(2000.0F).setStepSound(soundTypePiston).setBlockName("obsidian_uranium").setBlockTextureName("obsidian_uranium"));
